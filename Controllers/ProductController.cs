...
namespace QA.SportStore.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,CategoryID,Type,Quantity,Price,Description,Images,Sizes,Content")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,CategoryID,Type,Quantity,Price,Description,Images,Sizes,Content")] Product product)
        {
            if (id != product.ID)
            {
                return NotFound();
